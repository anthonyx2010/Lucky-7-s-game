...
function validateInput () {
  ...
  while (isNaN(betTest) || betTest < 1 || betTest > 100) {
    betTest = parseInt(prompt("Bet by entering a number from 1 to 100"));
  }
}
...
function populateResults () {
  ...
  if (betTest == maxMoney) results.innerHTML += "<p><mark>No Winner, Winner, Chicken Dinner!</mark></p>";
  if (count == betTest) results.innerHTML += "<p><mark><b>And not even one <i>Lucky 7</i>... Today is not your Lucky day!</b></mark></p>";
  showResults();
}
